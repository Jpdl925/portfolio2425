  ...
  export const projects = [
    {
      ...
      des: "Creating a enhanced version of an existing website. In this case me, and my team recreated the Valley Brewing website.",
      img: "/businessPic.svg",
      iconLists: ["/ht.svg", "/cs.svg"],
      link: "https://github.com/Jpdl925/BusinessRedevelopment",
    },
    {
      id: 2,
      title: "Moody",
      des: "Team created website named Moody. Calendar that tracks moods for each day with an AI chat feature.",
      img: "/moodyPic.svg",
      iconLists: ["/cs.svg", "/tail.svg", "/ts.svg", "/ht.svg", "/js.svg"],
      link: "https://github.com/Jpdl925/Moody",
    },
    {
      id: 3,
      title: "New Game App",
      des: "Redesigned game website created from a public API.",
      img: "/gamePic.svg",
      iconLists: ["/ts.svg", "/js.svg", "/ht.svg", "/cs.svg"],
      link: "https://github.com/Jpdl925/newgameappl",
    },
    {
      id: 4,
      title: "Weather App",
      des: "Created a website/application that can be used for finding the current weather of any given location as well as the 5 day forecast",
      img: "/weatherPic.svg",
      iconLists: ["/js.svg", "/ht.svg", "/cs.svg"],
      link: "https://github.com/Jpdl925/poncedeleonJWeatherApp",
    },
  ];
